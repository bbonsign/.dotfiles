" Override included mappings, as described in the help under
" 'Explicit Mappings'
...
function! s:vim_sexp_mappings()
  ...
  nmap <silent><buffer> <C-h>           <Plug>(sexp_move_to_prev_element_head)
  xmap <silent><buffer> <C-h>           <Plug>(sexp_move_to_prev_element_head)
  omap <silent><buffer> <C-h>           <Plug>(sexp_move_to_prev_element_head)
  nmap <silent><buffer> <C-l>           <Plug>(sexp_move_to_next_element_head)
  xmap <silent><buffer> <C-l>           <Plug>(sexp_move_to_next_element_head)
  omap <silent><buffer> <C-l>           <Plug>(sexp_move_to_next_element_head)
...
augroup VIM_SEXP_MAPPING
  autocmd!
  autocmd FileType clojure,scheme,racket,fennel,lisp,timl call s:vim_sexp_mappings()
augroup END
