;; [[file:config.org::*From the example doom config][From the example doom config:1]]
...
;; From the example doom config:1 ends here

;; [[file:config.org::*My Customizations][My Customizations:1]]
...
;; [[file:config.org::*Buffer Menu][Buffer Menu:1]]
...
;; [[file:config.org::*Theme Switcher][Theme Switcher:1]]
