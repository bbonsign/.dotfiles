...
setw -g window-status-current-format "#[fg=#1e2228,bg=#768390,nobold,nounderscore,noitalics]#[fg=#22272e,bg=#768390,bold] #I  #W#W#{?window_zoomed_flag, 🔍,} #F #[fg=#768390,bg=#1e2228,nobold,nounderscore,noitalics]"
